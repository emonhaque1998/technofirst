<x-home-layout>
    <x-package-breadcrumb pageName="Contact Us" linkOfCurrentPage="Contact Page"
                ...
                <div class="col-lg-5">
                    <div class="contact-form">
                        ...
                        <form id="contact-form"
                            action="https://template.hasthemes.com/glaxdu/glaxdu/assets/php/mail.php" method="post">
