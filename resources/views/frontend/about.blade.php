<x-home-layout>
    <x-package-breadcrumb pageName="About Us" linkOfCurrentPage="About Page"
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="single-about-chose-us mb-95">
                                    ...
                                    <div class="about-choose-content text-light-blue">
                                        ...
                                        <p>magna aliqua. Ut enim ad minim veniam conse ctetur adipisicing elit, sed
                                            do
                            ...
                            <div class="ms-auto col-lg-6 col-md-6">
                                <div class="testi-content bg-img default-overlay"
                                    ...
                                    <p>Lorem ipsum dolor sit amet, conse ctetur adipi sicing elit, sed do eiusm od
                                        tempor incidi dunt ut labore et dolore magna aliqua. Ut enim fugiat nulla
